...
function [A, b, res] = AssembleLinearSystem(x1, x2, s1, s2, problem, method)
    ...
    A_orth = AssembleOrtho(dx1ds1, dx1ds2, dx2ds1, dx2ds2, s1, s2, id);
...
function A_orth = AssembleOrtho(dx1ds1, dx1ds2, dx2ds1, dx2ds2, s1, s2, id)
    [Nx1, Nx2] = size(dx1ds1);
    N = Nx1*Nx2;
    N_all = N*2;
    ...
    [dDds1, dDds2] = DCentral(D, D, s1, s2);

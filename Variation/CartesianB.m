...
tolerance = 1e-6;
% Grid size
Nx1 = 40;  % Number of grid points in x1-direction
Nx2 = 40;  % Number of grid points in x2-direction
...
for iter = 1:max_iter
    ...
    % Check convergence
    if cost(x1, x2, s1, s2) > min_cost
        break
    end
    min_cost = cost(x1, x2, s1, s2);
    x1 = x1 + epsilon * dx1;
    x2 = x2 + epsilon * dx2;
